...
![Fuel Cell Stack Voltage-Current Characteristic Curve](results/fc_vi_curve.png)

### Fuel Cell Stack P-I Characteristic Curve
![Fuel Cell Stack Power-Current Characteristic Curve](results/fc_pi_curve.png)

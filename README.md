...
![Alt text][Fuel Cell Stack Voltage-Current Characteristic Curve](simulink_fuel_cell/results/fc_vi_curve.png)

### Fuel Cell Stack P-I Characteristic Curve
![Alt text][Fuel Cell Stack Power-Current Characteristic Curve](simulink_fuel_cell/results/fc_pi_curve.png)
